...
let queryDom = document.getElementById('search');
let senhaDom = document.getElementById('senha');
let usernameDom = document.getElementById('login');
let apiKeyDom = document.getElementById('api-key');
