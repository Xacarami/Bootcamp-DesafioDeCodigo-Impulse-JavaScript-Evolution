...
// entender como gera uma API key https://developers.themoviedb.org/3/getting-started/introduction
             ...
             // 11 de 44 erros no total até o momento

let queryDom = document.getElementById('search') as HTMLInputElement
let senhaDom = document.getElementById('senha') as HTMLInputElement
let usernameDom =  document.getElementById('login') as HTMLInputElement
let apiKeyDom = document.getElementById('api-key') as HTMLInputElement
...
if(searchButton){
    searchButton.addEventListener('click', async () => {
      ...
      if(queryDom){
          ...
          let query = queryDom.value;
          let listaDeFilmes:Array = await procurarFilme(query);
